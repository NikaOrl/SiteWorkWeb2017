...
<td width="130">
    <input class = "langKn" type="button" onclick="location.href='/history'" value="<fmt:message key="history"/>">
</td>
<td width="130">
<c:if test="${not empty sessionScope.userName}">
    <c:if test="${sessionScope.total_cost > 0}">
            <input class = "langKn" type="button" value="<fmt:message key="oformZ"/>" onclick="location.href='/order'">
    </c:if>
</c:if>
</td>
<td width="130">
